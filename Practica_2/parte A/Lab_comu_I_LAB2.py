...
class Lab_comu_I_LAB2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Prueba00", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Prueba00")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Lab_comu_I_LAB2")
        ...
        self.t_band = t_band = samp_rate/2000
        self.fm = fm = 10E3
        ...
        self._t_band_range = qtgui.Range(0, samp_rate/20, 100, samp_rate/2000, 200)
        self._t_band_win = qtgui.RangeWidget(self._t_band_range, self.set_t_band, "Banda de transisicon", "slider", float, QtCore.Qt.Horizontal)
        ...
        self._No_range = qtgui.Range(0, 25e-1, 1e-6, 1e-4, 200)
        ...
        self.uhd_usrp_sink_0.set_center_freq(GTX, 0)
        self.uhd_usrp_sink_0.set_antenna("TX/RX", 0)
        self.uhd_usrp_sink_0.set_gain(fc, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_t_band(self.samp_rate/2000)
    ...
    def set_fc(self, fc):
        self.fc = fc
        self.uhd_usrp_sink_0.set_gain(self.fc, 0)
    ...
    def set_GTX(self, GTX):
        self.GTX = GTX
        self.uhd_usrp_sink_0.set_center_freq(self.GTX, 0)
...
def main(top_block_cls=Lab_comu_I_LAB2, options=None):
