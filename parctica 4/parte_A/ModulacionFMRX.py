...
# Author: sebastian albornoz-carlos
...
class ModulacionFMRX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fcb_range = qtgui.Range(10e3, 100e3, 100, 100e3, 200)
        ...
        self._fc_win = qtgui.RangeWidget(self._fc_range, self.set_fc, "frecuencia corte portadora", "counter_slider", float, QtCore.Qt.Horizontal)
